...
const (
	// ExampleChainDenom is the denomination of Postworld Chain's base coin.
	ExampleChainDenom = "asurvive"

	// ExampleDisplayDenom is the display denomination of Postworld Chain's base coin.
	ExampleDisplayDenom = "survive"
