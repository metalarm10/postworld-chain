...
type Config struct {
	EvmdHttpEndpoint string `yaml:"postworldd_http_endpoint"`
	EvmdWsEndpoint   string `yaml:"postworldd_ws_endpoint"`
...
func MustLoadConfig() *Config {
	...
	postworlddURL := os.Getenv("EVMD_URL")
	if postworlddURL == "" {
		postworlddURL = EvmdHttpEndpoint
	}
	...
	postworlddWsURL := os.Getenv("EVMD_WS_URL")
	if postworlddWsURL == "" {
		postworlddWsURL = EvmdWsEndpoint
	}
	...
	return &Config{
		EvmdHttpEndpoint: postworlddURL,
		EvmdWsEndpoint:   postworlddWsURL,
