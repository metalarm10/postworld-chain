...
import (
	...
	clientkeys "github.com/metalarm10/postworld-chain/client/keys"
	"github.com/metalarm10/postworld-chain/crypto/hd"
	cosmosevmkeyring "github.com/metalarm10/postworld-chain/crypto/keyring"
	"github.com/metalarm10/postworld-chain/encoding"
	"github.com/metalarm10/postworld-chain/postworldd"
	"github.com/metalarm10/postworld-chain/postworldd/tests/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupEvmosApp() {
	...
	suite.app = postworldd.Setup(suite.T(), chainID.ChainID, chainID.EVMChainID)
