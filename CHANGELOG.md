...
- [\#645](https://github.com/cosmos/evm/pull/645) Align precise bank keeper for correct decimal conversion in postworldd.
...
- [\#648](https://github.com/cosmos/evm/pull/648) Move all `ante` logic such as `NewAnteHandler` from the `postworldd` package to `evm/ante` so it can be used as library functions.
...
- [\#443](https://github.com/cosmos/evm/pull/443) Move `ante` logic from the `postworldd` Go package to the `evm` package to
